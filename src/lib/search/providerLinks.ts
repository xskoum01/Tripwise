import type { ItineraryOption, LinkType } from "./types";

type ProviderLinkInput = Pick<ItineraryOption, "dates" | "destinationAirportCode" | "origin" | "source"> &
...
const providerHomepages: Record<ItineraryOption["source"], string> = {
...
function buildFallbackLink(option: ProviderLinkInput): ProviderLink {
  return {
    url: providerHomepages[option.source],
    linkType: "fallback",
  };
}
